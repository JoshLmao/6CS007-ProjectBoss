...
void AProjectBossCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AProjectBossCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AProjectBossCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AProjectBossCharacter::OnResetVR);
}


void AProjectBossCharacter::OnResetVR()
{
